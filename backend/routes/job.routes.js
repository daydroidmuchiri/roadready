...
function createJobRouter({
  ...
  router.post('/jobs', auth, requireRole('motorist'), asyncHandler(async (req, res) => {
  ...
  router.patch('/jobs/:id/status', auth, asyncHandler(async (req, res) => {
  ...
  router.post('/jobs/:id/rating', auth, asyncHandler(async (req, res) => {
